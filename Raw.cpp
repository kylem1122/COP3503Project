...
//check if piece exists on a map 
...
void userAddShip(Map& userMap){
    string choice = "";
    cout << endl <<"Your current board is:" << endl << endl;		//display player map
    userMap.print();
    do{
        ...
        cout << left << setw(18) << setfill(separator) << "Aircraft Carrier";	//choose ship to add from list
        ...
        //checks for aircraft carrier
        if(choice == "a"){
            if(checkExistence(userMap, "A")){		//checks to see if ship is already placed
            ...
            cout << "Which direction would you like your ship?" << endl;	//choose orientation to add ship in
            ...
            if (choice == "horizontal" || choice == "h"){
                cout << endl << "Where would you like to place the farthest left edge? ";	//input placement
                cin >> choice;
                transform(choice.begin(), choice.end(), choice.begin(), ::tolower);
                int column = 0;
                int row = 0;
                
                if(choice[0] >= 'a' && choice[0] < 'g'){	//choose column
                    column = choice[0] - 'a';
                    if(choice[1] > '0' && choice[1] <= '9'){	//choose row
                        if(choice.size() == 3){
                            if(choice[2] == '0'){	//checks to see if row 10
                                row = 9;
                            }
                            else{
                        ...
                        else if(choice.size() > 3){		//is input too long - invalid input
                            cout << "Invalid selection." << endl << endl;
                            return;
                        }
                        else{	//row is set
                        ...
                        for(int i = 0; i != 5; i++){	//checks to see if a ship is occupying space
                            if(userMap.getItemAt(row,column+i).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 5; i++){	//place carrier horizontally at position on map
                            Item* aircraftCarrier = new Item(5, "A", false);
                            userMap.setItemAt(row, column+i, *aircraftCarrier);
                        }
                        cout << endl << endl << "Your new map is: " << endl << endl;	//show new map
                        userMap.print();
                    }
                    else{
                        cout << "Invalid selection." << endl << endl;
            ...
            //chose vertical
                ...
                cout << endl << "Where would you like to place the topmost edge? ";		//input placement
                cin >> choice;
                transform(choice.begin(), choice.end(), choice.begin(), ::tolower);
                int column = 0;
                int row = 0;
                
                if(choice[0] >= 'a' && choice[0] < 'k'){	//choose column
                    column = choice[0] - 'a';
                    if(choice[1] > '0' && choice[1] <= '6'){	//choose row
                        if(choice.size() >= 3){		//checks to see if input is not valid
                            cout << "Invalid selection." << endl << endl;
                            return;
                        }
                        else{	//set row
                        ...
                        for(int i = 0; i != 5; i++){	//check to see if ship already occupies spot
                            if(userMap.getItemAt(row+i,column).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 5; i++){	//place carrier at spot on map veritcally
                            Item* aircraftCarrier = new Item(5, "A", false);
                            userMap.setItemAt(row+i, column, *aircraftCarrier);
                        }
                        cout << endl << endl << "Your new map is: " << endl << endl;	//print updated player map
                        userMap.print();
                    }
                    else{
                        cout << "Invalid selection." << endl << endl;
            ...
            cout << "Would you like to add another piece? (yes/no) ";	//checks to see if additional manual placement wanted
            cin >> choice;
            transform(choice.begin(), choice.end(), choice.begin(), ::tolower);
        }
        //checks for battleship
        else if(choice == "b"){
            if(checkExistence(userMap, "B")){
                cout << "This piece is currently on the board."<< endl;		//checks to see if ship already placed on board
                cout << "Please modify current pieces through the main menu" << endl;
                return;
            }
            ...
            if (choice == "horizontal" || choice == "h"){
                ...
                if(choice[0] >= 'a' && choice[0] < 'h'){
                    ...
                    if(choice[1] > '0' && choice[1] <= '9'){
                        ...
                        for(int i = 0; i != 4; i++){	//check to see if ship occupies spot
                            if(userMap.getItemAt(row,column+i).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 4; i++){	//place battleship into horizontal space
                ...
                if(choice[0] >= 'a' && choice[0] < 'k'){
                    ...
                    if(choice[1] > '0' && choice[1] <= '7'){
                        ...
                        for(int i = 0; i != 4; i++){ 	//checks to see if ship occupies spot on board already
                            if(userMap.getItemAt(row+i,column).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 4; i++){	//place battleship into vertical space
                            Item* battleship = new Item(4, "B", false);
        ...
        //ADD SUBMARINE
            ...
            if(checkExistence(userMap, "S")){
                cout << "This piece is currently on the board."<< endl;		//checks to see if sub on board already
                cout << "Please modify current pieces through the main menu" << endl;
                return;
            }
            ...
            if (choice == "horizontal" || choice == "h"){
                ...
                if(choice[0] >= 'a' && choice[0] < 'i'){
                    ...
                    if(choice[1] > '0' && choice[1] <= '9'){
                        ...
                        for(int i = 0; i != 3; i++){	//checks to see if ship already on spots specified
                            if(userMap.getItemAt(row,column+i).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 3; i++){	//places sub horizontally on board at index
                            Item* submarine = new Item(3, "S", false);
                            userMap.setItemAt(row, column+i, *submarine);
                        }
                        cout << endl << endl << "Your new map is: " << endl << endl;	//print updated map
                        userMap.print();
                    }
                    else{
                        cout << "Invalid selection." << endl << endl;
            ...
            //chose vertical
                ...
                if(choice[0] >= 'a' && choice[0] < 'k'){
                    ...
                    if(choice[1] > '0' && choice[1] <= '8'){
                        ...
                        for(int i = 0; i != 3; i++){	//checks to see if ship placed on indexes already
                            if(userMap.getItemAt(row+i,column).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 3; i++){	//place sub on indexes vertically
                            Item* submarine = new Item(3, "S", false);
            ...
            cout << "Would you like to add another piece? (yes/no) ";	//checks to see if additional manual ship placement wanted
            cin >> choice;
            transform(choice.begin(), choice.end(), choice.begin(), ::tolower);
        }
        ...
        //ADD CRUISER
            ...
            if(checkExistence(userMap, "C")){
                cout << "This piece is currently on the board."<< endl;		//checks to see if ship already placed
                cout << "Please modify current pieces through the main menu" << endl;
                return;
            }
            ...
            if (choice == "horizontal" || choice == "h"){
                ...
                if(choice[0] >= 'a' && choice[0] < 'i'){
                    ...
                    if(choice[1] > '0' && choice[1] <= '9'){
                        ...
                        for(int i = 0; i != 3; i++){	//checks for ships already placed on indexes specified
                            if(userMap.getItemAt(row,column+i).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 3; i++){	//places cruiser horizontally on board
            ...
            //chose vertically
                ...
                if(choice[0] >= 'a' && choice[0] < 'k'){
                    ...
                    if(choice[1] > '0' && choice[1] <= '8'){
                        ...
                        for(int i = 0; i != 3; i++){		//checks to see if ships placed on board block placement
                            if(userMap.getItemAt(row+i,column).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 3; i++){	//add cruiser vertically if space empty
                            Item* cruiser = new Item(3, "C", false);
            ...
            cout << "Would you like to add another piece? (yes/no) ";	//check for wanted additional maunal ship placement
            cin >> choice;
            transform(choice.begin(), choice.end(), choice.begin(), ::tolower);
        }
        ...
        //ADD DESTROYER
            ...
            if(checkExistence(userMap, "D")){
                cout << "This piece is currently on the board."<< endl;		//checks is ship already on board
                cout << "Please modify current pieces through the main menu" << endl;
                return;
            }
            ...
            if (choice == "horizontal" || choice == "h"){
                ...
                if(choice[0] >= 'a' && choice[0] < 'j'){
                    ...
                    if(choice[1] > '0' && choice[1] <= '9'){
                        ...
                        for(int i = 0; i != 2; i++){	//checks to see if ship in way of placement on board
                            if(userMap.getItemAt(row,column+i).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 2; i++){	//add destroyed if spaces empty
            ...
            //chose vertical
                ...
                if(choice[0] >= 'a' && choice[0] < 'k'){
                    ...
                    if(choice[1] > '0' && choice[1] <= '9'){
                        ...
                        for(int i = 0; i != 2; i++){	//checks to see if ship blocks placement
                            if(userMap.getItemAt(row+i,column).getName() != "~"){
                                cout << "Another ship is already here" << endl;
                                return;
                            }
                        }
                        for(int i = 0; i != 2; i++){	//add destroyer if placement clear
                            Item* destroyer = new Item(3, "D", false);
            ...
            cout << "Would you like to add another piece? (yes/no) ";	//request further manual ship placement
            cin >> choice;
            transform(choice.begin(), choice.end(), choice.begin(), ::tolower);
        }
        else{
